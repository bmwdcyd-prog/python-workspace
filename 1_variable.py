...
sting b = "문자들" b 상자에는 문자들만 들어갈 수 있습니다.
...
개발자가 개발하는데 있어 편의 우선
변수 이름 지정 할 때 규칙
맨 앞글자로 숫자가 들어가면 안되고, 변수이름 사이에 띄어쓰기 존재해서 안됨



print("http://www.google.com")
print ("search website : http://www.google.com")
...
print ("search website : http://www.naver.com")
print ("my home page website : https://www.naver.com")

# 동일한 데이터를 여러 번 작성하고, 관리해야할 때 변수이름에 데이터를 담아 손쉽게 관리할 수 있다.
website = "https://www.naver.com" # website 라는 공간에는 https://www.naver.com 명칭이 담겨져 있는 것
